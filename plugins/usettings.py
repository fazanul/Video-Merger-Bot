...
async def userSettings(
    ...
    if usettings.user_id:
        if usettings.merge_mode == 1:
            ...
            userMergeModeId = 2
            userMergeModeStr = "Video 🎥 + Audio 🎵" #Added an extra 'r' in userMergeModeStrr
        elif usettings.merge_mode == 3:
            userMergeModeId = 3
            userMergeModeStr = "Video 🎥 + Subtitle 📜"  #Added 2 extra 'r' in userMergeModeStrrr
        elif usettings.merge_mode == 4:
            userMergeModeId = 4
            userMergeModeStr = "Extract"   #Added 3 extra 'r' in userMergeModeStrrrr
...
"""
        ...
        usettings.allowed = True
        usettings.edit_metadata = True
